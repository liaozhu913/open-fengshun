...
BUSINESSES = [
    ...
    # ===== 小红书补充 - 餐饮 =====
    {"name": "米街3号捆粄店", "category": "餐饮", "subcategory": "客家小吃", "town": "汤坑镇", "address": "丰顺县米街3号", "phone": "", "description": "皮薄馅足，经典口味如豆干韭菜、豆角瘦肉、酸菜肉，搭配炖汤解腻。小红书人气捆粄店。", "price_range": "人均10-20", "rating": 4.5, "tags": ["捆粄", "老字号", "小红书推荐"], "source": "xiaohongshu"},
    {"name": "老鹅干面促肉", "category": "餐饮", "subcategory": "面食", "town": "汤坑镇", "address": "丰顺县汤坑镇金湖路", "phone": "", "description": "猪肉打底，炸蒜香浓郁，面条有嚼劲，搭配肉丸汤或凉拌皮蛋。营业时间17:30-03:30，夜宵名店。", "price_range": "人均20-35", "rating": 4.4, "tags": ["干面", "促肉", "夜宵"], "source": "xiaohongshu"},
    {"name": "金石汤粉（滨江分店）", "category": "餐饮", "subcategory": "汤粉", "town": "汤坑镇", "address": "丰顺县富岭路", "phone": "", "description": "牛骨汤底浓郁，牛肉新鲜，汤粉+腌面套餐经典搭配。小红书人气汤粉店。", "price_range": "人均20+", "rating": 4.4, "tags": ["汤粉", "牛骨汤", "腌面"], "source": "xiaohongshu"},
    {"name": "白塔牛肉火锅店", "category": "餐饮", "subcategory": "牛肉火锅", "town": "汤坑镇", "address": "丰顺县汤坑镇", "phone": "", "description": "每日限定新鲜水牛肉，全牛宴体验，火锅+烤肉双拼，椒盐炸牛排骨必点。小红书高赞推荐。", "price_range": "人均60-100", "rating": 4.6, "tags": ["牛肉火锅", "全牛宴", "烤肉", "小红书推荐"], "source": "xiaohongshu"},
    {"name": "老厂房串串火锅", "category": "餐饮", "subcategory": "串串", "town": "汤坑镇", "address": "丰顺县富岭路", "phone": "", "description": "有团购优惠，楼下有糖水店可搭配。丰顺串串火锅人气店。", "price_range": "人均40-60", "rating": 4.2, "tags": ["串串", "火锅", "团购"], "source": "xiaohongshu"},
    {"name": "老杨夜宵店", "category": "餐饮", "subcategory": "夜宵", "town": "汤坑镇", "address": "丰顺县汤坑镇", "phone": "", "description": "潮汕粥入味，夜宵热门选择，各式潮汕小炒。", "price_range": "人均20-40", "rating": 4.3, "tags": ["潮汕粥", "夜宵", "小炒"], "source": "xiaohongshu"},
    {"name": "蔡玉皎·传统薄皮蒸饺", "category": "餐饮", "subcategory": "客家小吃", "town": "汤坑镇", "address": "丰顺县汤坑镇", "phone": "", "description": "皮薄馅足，传统手工蒸饺，性价比高。小红书推荐。", "price_range": "人均15-25", "rating": 4.3, "tags": ["蒸饺", "手工", "性价比"], "source": "xiaohongshu"},
    {"name": "竹棚全牛", "category": "餐饮", "subcategory": "牛肉火锅", "town": "汤坑镇", "address": "丰顺县汤坑镇", "phone": "", "description": "现宰牛肉，自制调料，全牛火锅。当地人推荐。", "price_range": "人均60-90", "rating": 4.5, "tags": ["牛肉火锅", "现宰", "全牛"], "source": "xiaohongshu"},
    {"name": "米街冰室", "category": "餐饮", "subcategory": "甜品", "town": "汤坑镇", "address": "丰顺县米街", "phone": "", "description": "绵密冰沙搭配新鲜水果，夏日消暑首选。各种传统甜品。", "price_range": "人均10-20", "rating": 4.2, "tags": ["冰沙", "甜品", "消暑"], "source": "xiaohongshu"},

    # ===== 小红书补充 - 住宿 =====
    {"name": "十里芸溪温泉别墅", "category": "住宿", "subcategory": "私汤别墅", "town": "汤坑镇", "address": "丰顺县", "phone": "", "description": "「夏至」套房带天台独立温泉池，可俯瞰山景，适合情侣或小团体。私密性好。", "price_range": "500-1000", "rating": 4.6, "tags": ["私汤", "别墅", "情侣", "山景"], "source": "xiaohongshu"},
    {"name": "海棠湾温泉度假别墅", "category": "住宿", "subcategory": "私汤别墅", "town": "汤坑镇", "address": "丰顺县", "phone": "", "description": "5房中式庭院别墅，带独立泡池、亲子乐园和麻将房，适合家庭聚会或团建。", "price_range": "800-2000", "rating": 4.5, "tags": ["别墅", "庭院", "亲子", "团建", "麻将"], "source": "xiaohongshu"},
    {"name": "望江湾民宿", "category": "住宿", "subcategory": "民宿", "town": "汤坑镇", "address": "丰顺县鹿湖温泉附近", "phone": "", "description": "鹿湖温泉周边民宿，129元/晚起，性价比高，适合预算有限的游客。", "price_range": "129+", "rating": 4.0, "tags": ["民宿", "性价比", "鹿湖周边"], "source": "xiaohongshu"},
    {"name": "罗浮空中温泉酒店", "category": "住宿", "subcategory": "温泉酒店", "town": "汤坑镇", "address": "丰顺县", "phone": "", "description": "梅州唯一空中温泉，无边际泳池+水上乐园，适合年轻群体。", "price_range": "300-600", "rating": 4.4, "tags": ["空中温泉", "无边际泳池", "水上乐园"], "source": "xiaohongshu"},

    # ===== 小红书补充 - 景点 =====
    {"name": "鸿图嶂", "category": "旅游", "subcategory": "自然景观", "town": "八乡山镇", "address": "丰顺县八乡镇", "phone": "", "description": "海拔1200多米，自驾可直达山顶。适合看日出日落，山顶视野开阔，夏季需备长袖。小红书小众秘境推荐。", "price_range": "免费", "rating": 4.5, "tags": ["日出", "日落", "自驾", "小众", "免费"], "source": "xiaohongshu"},
    {"name": "龙飞磜瀑布", "category": "旅游", "subcategory": "自然景观", "town": "汤坑镇", "address": "丰顺县龙归寨瀑布上游", "phone": "", "description": "龙归寨瀑布上游，未开发秘境，人少景幽，溪水清澈，瀑布分大小两级，适合森系拍照和徒步。", "price_range": "免费", "rating": 4.4, "tags": ["瀑布", "秘境", "徒步", "拍照", "免费"], "source": "xiaohongshu"},
    {"name": "茶子窝瀑布", "category": "旅游", "subcategory": "自然景观", "town": "砂田镇", "address": "丰顺县砂田镇占中村附近", "phone": "", "description": "藏于山弯，免费开放，沿小径步行可达，周边占中村保留古石桥和原生态村落，适合避暑、玩水。", "price_range": "免费", "rating": 4.3, "tags": ["瀑布", "避暑", "玩水", "古村", "免费"], "source": "xiaohongshu"},
    {"name": "埔河文庙（文昌阁）", "category": "旅游", "subcategory": "人文景观", "town": "汤坑镇", "address": "丰顺县汤坑镇埔河村口（东海中学旁）", "phone": "", "description": "400余年历史古建筑，免费开放，木质结构保存完好，登塔可俯瞰周边。", "price_range": "免费", "rating": 4.2, "tags": ["古建筑", "文庙", "历史", "免费"], "source": "xiaohongshu"},
    {"name": "惠仁圣寺", "category": "旅游", "subcategory": "人文景观", "town": "汤坑镇", "address": "丰顺县鸳鸯寨森林公园附近", "phone": "", "description": "当地最大寺院，盛唐风格建筑，亭台楼阁错落，环境清幽肃穆。", "price_range": "免费", "rating": 4.2, "tags": ["寺院", "盛唐风格", "清幽", "免费"], "source": "xiaohongshu"},
    {"name": "蔗溪村露营钓鱼", "category": "旅游", "subcategory": "户外体验", "town": "留隍镇", "address": "丰顺县留隍镇蔗溪村", "phone": "", "description": "桥下浅水区可玩水避暑，提供石桌石凳，适合露营、钓鱼，免费开放。", "price_range": "免费", "rating": 4.1, "tags": ["露营", "钓鱼", "玩水", "免费"], "source": "xiaohongshu"},
]
